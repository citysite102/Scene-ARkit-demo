...
- (void)registerGameController:(GCController *)gameController {
    ...
    _gamePadLeft = extendedGamepad.leftThumbstick;
    _gamePadRight = extendedGamepad.rightThumbstick;
    ...
    [extendedGamepad.buttonA setValueChangedHandler:^(GCControllerButtonInput * _Nonnull button, float value, BOOL pressed) {
        [weakController controllerJump:pressed];
    }];

    [extendedGamepad.buttonB setValueChangedHandler:^(GCControllerButtonInput * _Nonnull button, float value, BOOL pressed) {
        if (pressed) {
